...
import com.xu.design.DTO.mq.*;
import com.xu.design.utils.MqProducerUtil;
...
@RestController
@RequestMapping("/mq")
public class MqProducerTestController {
    @Resource
    ...
    public Object pushMessage(@RequestParam("id") int id) {
        ...
        log.info("pushMessage finish : " + id + ", sendResult : " + JSONUtil.toJsonStr(sendResult));
        // 解析发送结果
    ...
    public Object pushAsyncMessage(@RequestParam("id") Long id) {
        log.info("pushAsyncMessage start : " + id);
        // 构建消息
//        String messageStr = "order id : " + id;
        MqMessageDTO mqMessageDTO = new MqMessageDTO();
        mqMessageDTO.setId(1);
        mqMessageDTO.setName("HFXKS");
        mqProducerUtil.sendAsyncTag(asyncTag, mqMessageDTO);
//        Message<MqMessageDTO> message = MessageBuilder.withPayload(mqMessageDTO)
//                .setHeader(RocketMQHeaders.KEYS, id)
//                .build();
//        // 设置发送地和消息信息并发送异步消息
...
//        log.info("pushAsyncMessage finish : " + id);
    ...
    public Object pushOneWayMessage(@RequestParam("id") int id) {
    ...
    public Object pushSequeueMessage(@RequestParam("id") int id) {
    ...
    public Object pushDelayMessage(@RequestParam("id") int id) {
        ...
        log.info("pushDelayMessage finish : " + id + ", sendResult : " + JSONUtil.toJsonStr(sendResult));
    ...
    public Object pushSqlMessage(@RequestParam("id") int id) {
    ...
    public ResponseMsg pushTransactionMessage(@RequestParam("id") int id) {
        ...
        log.info("pushTransactionMessage result : " + JSONUtil.toJsonStr(transactionSendResult));
